...
public class PlayerUpdateRotationEvent extends PlayerEvent implements Cancellable
{
    ...
    public PlayerUpdateRotationEvent(final Player player, final Location from, final Location to) {
        super(player);
        this.cancel = false;
        this.from = from;
        this.to = to;
    ...
    public HandlerList getHandlers() {
        return PlayerUpdateRotationEvent.handlers;
    }
